package com.kafkatemplete.config;//package com.kafkalearn.config;
//
...
//
//        configMap.put(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG,autoCommit );
//        configMap.put(ConsumerConfig.AUTO_COMMIT_INTERVAL_MS_CONFIG, linger);
////        configMap.put(ConsumerConfig.SESSION_TIMEOUT_MS_CONFIG, 30);
...
////        props.put(ProducerConfig.ACKS_CONFIG, ack);//单个brok 推荐使用'1'
